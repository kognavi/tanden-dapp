...
const deployedContracts = {
    ...
    TandenNFT: {
      ...
      abi: [
        ...
        },
        {
          ...
          outputs: [
            {
              internalType: "contract ITandenToken",
              name: "",
              type: "address",
            },
          ],
  ...
  11155111: {
    TandenBank: {
      address: "0x489CFa5FeE93a96782E95558fCFc19486605455D",
      abi: [
        {
          inputs: [],
          name: "ReentrancyGuardReentrantCall",
      ...
      inheritedFunctions: {},
      deployedOnBlock: 10510701,
    },
    TandenNFT: {
      address: "0xF6ad5A7240FD3c1488788e1CDCaE2a4ED6397E0d",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 10510700,
    },
    TandenToken: {
      address: "0xd98aDB1d3B3819DA92f9b2A3DEb24cDf9643a6cA",
      abi: [
        {
          inputs: [],
          stateMutability: "nonpayable",
      ...
      deployedOnBlock: 10361727,
    },
    YourContract: {
      address: "0x466f3C934B51bAe9318FF991ECa0C661B48C6741",
      abi: [
        {
          inputs: [
            {
